...
VOLUME_HOME="/var/lib/mysql${1}"
CONF_FILE="/etc/mysql${1}/conf.d/my.cnf"
LOG="/var/log/mysql${1}/error.log"

# Set permission of config file
chmod 644 /etc/mysql$1/conf.d/mysqld_charset.cnf

StartMySQL ()
{
    /usr/bin/mysqld_safe --defaults-file=/etc/mysql/my$1.cnf > /dev/null 2>&1 &
